...
class TestAPICalls(unittest.TestCase):
    def test_upper(self):
        ...
        campaigns = api.get_campaigns_report_by_date("2021-05-18", "2021-05-18", group_by="countryOrRegion", return_grand_totals=False)
        print(campaigns)
        print()
        print(len(campaigns)) 
        ...
        for c in campaigns:
            if c["metadata"]["app"]["adamId"] == 1529233374:
                print(c['total']["localSpend"]["amount"])#, c["metadata"]["campaignName"])
